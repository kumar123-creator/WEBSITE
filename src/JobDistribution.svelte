<script>
  ...
  <section class="recruiting-tracking-section">
    <div class="links">
      <nav>
        <ul >
...
<h style="color:green; ">Boost Application Completion Rates</h>
  ...
  .recruiting-tracking-section h{
    ...
    .recruiting-tracking-section h2 {
        margin-top: 1px;
    margin-bottom: 1px;
      font-weight: bold;
      font-size: 3rem;
    }
    .recruiting-tracking-section p {
     
      font-weight: bold;
      font-size: 1.5rem;
    }
  
    .recruiting-tracking-section h3 {
  
      font-weight: bold;
      font-size: 1.7rem;
      margin-top: 50px;
    }
    .recruiting-tracking-section h6 {
