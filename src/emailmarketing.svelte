...
<section class="recruiting-email-section">
  <div class="links">
    <nav>
      <ul >
...
.recruiting-email-section h{
   
   font-weight: bold;
   font-size: 2rem;
   margin-top: 80px;
 }
  .recruiting-email-section h2 {
      margin-top: 1px;
  margin-bottom: 1px;
    font-weight: bold;
    font-size: 3rem;
  }
  .recruiting-email-section p {
   
    font-weight: bold;
    font-size: 1.5rem;
  }

  .recruiting-email-section h3 {

    font-weight: bold;
    font-size: 1.7rem;
    margin-top: 50px;
  }
  .recruiting-email-section h6 {
